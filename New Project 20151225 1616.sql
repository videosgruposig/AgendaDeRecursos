...
INSERT INTO `ambiente` (`idAmbiente`,`EstadoConservacion`,`Observaciones`,`Superficiemt2`,`TipoCubierta`,`Nombre`) VALUES 
 (3,'Regular','observaciones 2',94,'Exterior','Sala 1 '),
 (5,'Bueno','observaciones',342,'Cubierta','Sala 2');
...
INSERT INTO `cargoporestablecimiento` (`idCargoPorEstablecimiento`,`NomencladorCargosPOF_idNomencladorCargosPOF`,`UnidadEducativa_idUnidadEducativa`,`FechaCreacion`,`Año`,`Division`,`Turno`,`Horas`,`Observaciones`) VALUES 
 ...
 (4,1,2,'2015-12-03 13:06:51','1','B','Mañana',40,''),
...
INSERT INTO `cursoseccion` (`idCursoSeccion`,`AliasCurso`,`AliasDivision`,`Curso`,`Division`,`FechaCreacion`,`InstrumentoLegal`,`Matricula`,`MotivoCreacion`,`Observaciones`,`TipoInstrumentoLegal`,`Turno`,`Agrupaciones_idAgrupaciones`) VALUES 
 ...
 (28,'Primero','División A','1','A','2015-12-18 19:51:49','1324','23','N/A','...','Decreto','Mañana',4);
...
INSERT INTO `distribucionporcargo` (`idDistribucionPorCargo`,`FechaVinculo`,`FechaDesvinculo`,`CursoSeccion_idCursoSeccion`,`CargoPorEstablecimiento_idCargoPorEstablecimiento`,`MateriaAsociada_idMateriaAsociada`) VALUES 
 (1,'2015-12-15 21:02:58','0001-01-01 00:00:00',2,1,5),
 (2,'2015-12-17 12:34:46',NULL,3,1,1),
 (4,'2015-12-18 18:38:36',NULL,2,1,1),
 (5,'2015-12-18 19:52:35',NULL,28,4,7),
 (6,'2015-12-18 20:08:24',NULL,2,1,9),
 (7,'2015-12-25 13:30:33',NULL,28,4,8);
...
INSERT INTO `materias` (`idMaterias`,`Alias`,`Nombre`,`Ciclo`,`Contenido`,`InstrumentoLegal`,`Nivel`,`NucleoDisciplinaAfin`,`TipoInstrumentoLegal`,`CargaHorariaSugeridaHsReloj`) VALUES 
 ...
 (11,'Historia I','Historia I','Único',NULL,'34','Único','Ciencias Básicas','Ley',NULL);
...
--
-- Definition of procedure `ActualizarAmbiente`
--

DROP PROCEDURE IF EXISTS `ActualizarAmbiente`;

DELIMITER $$

/*!50003 SET @TEMP_SQL_MODE=@@SQL_MODE, SQL_MODE='STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ $$
CREATE DEFINER=`root`@`localhost` PROCEDURE `ActualizarAmbiente`(

ridAmbiente INT, 
rEstadoConservacion VARCHAR(45), 
rObservaciones VARCHAR(45), 
rSuperficiemt2 INT, 
rTipoCubierta VARCHAR(45), 
rNombre VARCHAR(45)
...
idAmbiente = ridAmbiente, 
EstadoConservacion = rEstadoConservacion, 
Observaciones = rObservaciones, 
Superficiemt2 = rSuperficiemt2, 
TipoCubierta = rTipoCubierta, 
Nombre = rNombre
...
--
-- Definition of procedure `ActualizarDistribucionPorCargo`
--

DROP PROCEDURE IF EXISTS `ActualizarDistribucionPorCargo`;

DELIMITER $$

/*!50003 SET @TEMP_SQL_MODE=@@SQL_MODE, SQL_MODE='STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ $$
CREATE DEFINER=`root`@`localhost` PROCEDURE `ActualizarDistribucionPorCargo`(
ridDistribucionPorCargo								INT, 
rFechaVinculo										DATETIME, 
rFechaDesvinculo									DATETIME,
...
UPDATE distribucionporcargo 
SET
idDistribucionPorCargo								= ridDistribucionPorCargo, 
FechaVinculo										= rFechaVinculo, 
FechaDesvinculo										= rFechaDesvinculo,
CursoSeccion_idCursoSeccion							= rCursoSeccion_idCursoSeccion, 
CargoPorEstablecimiento_idCargoPorEstablecimiento	= rCargoPorEstablecimiento_idCargoPorEstablecimiento, 
MateriaAsociada_idMateriaAsociada					= rMateriaAsociada_idMateriaAsociada	
WHERE 
...
--
-- Definition of procedure `CargarAmbiente`
--

DROP PROCEDURE IF EXISTS `CargarAmbiente`;

DELIMITER $$

/*!50003 SET @TEMP_SQL_MODE=@@SQL_MODE, SQL_MODE='STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ $$
CREATE DEFINER=`root`@`localhost` PROCEDURE `CargarAmbiente`(
IN 
ridAmbiente INT,
rNombre VARCHAR(45)
 )
...
--
-- Definition of procedure `CargarCargoVinculado`
--

DROP PROCEDURE IF EXISTS `CargarCargoVinculado`;

DELIMITER $$

/*!50003 SET @TEMP_SQL_MODE=@@SQL_MODE, SQL_MODE='STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ $$
CREATE DEFINER=`root`@`localhost` PROCEDURE `CargarCargoVinculado`(IN ridCargoVinculado INT)
BEGIN
select
* 
from
distribucionporcargo
where 
idDistribucionPorCargo = ridCargoVinculado; 	
END $$
/*!50003 SET SESSION SQL_MODE=@TEMP_SQL_MODE */  $$
...
--
-- Definition of procedure `CargarMateriaAsociada`
--

DROP PROCEDURE IF EXISTS `CargarMateriaAsociada`;

DELIMITER $$

/*!50003 SET @TEMP_SQL_MODE=@@SQL_MODE, SQL_MODE='STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ $$
CREATE DEFINER=`root`@`localhost` PROCEDURE `CargarMateriaAsociada`(IN ridMateriaAsociada INT)
BEGIN
select 
* 
from 
materiaasociada
where 
materiaasociada.idMateriaAsociada = ridMateriaAsociada ;
END $$
/*!50003 SET SESSION SQL_MODE=@TEMP_SQL_MODE */  $$
...
--
-- Definition of procedure `CargarNomencladorCargoPOF`
--

DROP PROCEDURE IF EXISTS `CargarNomencladorCargoPOF`;

DELIMITER $$

/*!50003 SET @TEMP_SQL_MODE=@@SQL_MODE, SQL_MODE='STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ $$
CREATE DEFINER=`root`@`localhost` PROCEDURE `CargarNomencladorCargoPOF`(IN ridNomencladorCargosPOF INT, rDescripcion VARCHAR(45))
BEGIN
select
		*
from
nomencladorcargospof
where 
		Descripcion like rDescripcion or
		idNomencladorCargosPOF = ridNomencladorCargosPOF;
END $$
/*!50003 SET SESSION SQL_MODE=@TEMP_SQL_MODE */  $$
...
--
-- Definition of procedure `EliminarAmbiente`
--

DROP PROCEDURE IF EXISTS `EliminarAmbiente`;

DELIMITER $$

/*!50003 SET @TEMP_SQL_MODE=@@SQL_MODE, SQL_MODE='STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ $$
CREATE DEFINER=`root`@`localhost` PROCEDURE `EliminarAmbiente`(IN ID INT)
BEGIN
...
--
-- Definition of procedure `InsertarAmbiente`
--

DROP PROCEDURE IF EXISTS `InsertarAmbiente`;

DELIMITER $$

/*!50003 SET @TEMP_SQL_MODE=@@SQL_MODE, SQL_MODE='STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ $$
CREATE DEFINER=`root`@`localhost` PROCEDURE `InsertarAmbiente`(
rEstadoConservacion  VARCHAR(45),   
rObservaciones  VARCHAR(45),  
rSuperficiemt2 INT, 
rTipoCubierta  VARCHAR(45),   
